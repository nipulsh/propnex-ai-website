...
export function PhoneNumbersTable() {
  ...
  function getAssignedAgentName(entry: (typeof numbers)[0]): string {
    if (entry.inboundAgentName && entry.inboundAgentName !== "Unassigned") {
      return entry.inboundAgentName;
    }
    if (entry.outboundAgentName && entry.outboundAgentName !== "Unassigned") {
      return entry.outboundAgentName;
    }
    return "Unassigned";
  }
  ...
  return (
    <SetupSection
      id="phone-numbers"
      title="Phone Numbers"
      description="Manage phone numbers, agent assignments, and channel allocation."
    >
          ...
          <table className="w-full min-w-[800px] text-left text-sm">
            <thead>
              <tr className="border-b border-propnex-border text-[0.65rem] tracking-[0.12em] text-propnex-muted uppercase">
                ...
                <th className="px-5 py-3 font-medium">Channel Count</th>
            ...
            <tbody>
              {numbers.length === 0 ? (
                <tr>
                  ...
                  >
                    No phone numbers yet. Purchase numbers from Billing to get
                    started.
                  </td>
                </tr>
              ) : (
                numbers.map((entry) => {
                  ...
                  const assignedName = getAssignedAgentName(entry);
                      ...
                      <td className="px-5 py-4">
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            disabled={isDisabled || assignedName === "Unassigned"}
            ...
            <div className="mb-5 flex items-start justify-between gap-4">
              <div>
                ...
                <DialogPrimitive.Description className="mt-1 text-sm text-propnex-muted">
                  Select an AI agent for this phone number.
